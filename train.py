...
# 1. Suppress TensorFlow's CPU feature and oneDNN info logs (Level '2' hides Info & Warnings)
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'

# 2. Optional: Turn off oneDNN if you want exact numerical consistency
os.environ['TF_ENABLE_ONEDNN_OPTS'] = '0'

# 3. Suppress Python/Keras UserWarnings
